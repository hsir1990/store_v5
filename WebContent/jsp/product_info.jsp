...
<html>
		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<form id="myFrom" method="post" action="${pageContext.request.contextPath}/CartServlet?method=addCartItemToCart">
						...
						<div class="col-md-6">
							<div><strong>大${product.pname}</strong></div>
	...
	$(function(){
		$('#btnId').click(function(){
			var fromObj = document.getElementById("myFrom");
			//可以设置action和method
			//fromObj.action="/store_v5/CartServlet";
			//fromObj.method="get";
			fromObj.submit();
		})
	})
